...
public class VoluntariadoPresenter {
    private View view;
    private Activity contexto;
    private Voluntariado voluntariado;


    public VoluntariadoPresenter(View view, Activity contexto){
        this.contexto = contexto;
        this.view = view;
    }

    public void trazVoluntariados(int idVoluntario) {

        String urlVoluntariado = contexto.getString(R.string.web_service_url) + "voluntariado?id_voluntario="+ idVoluntario ;
        new ConsomeServico(urlVoluntariado, ConsomeServico.Metodo.GET, new ConsomeServico.PosExecucao() {
            ...
            public void executa(String resultado, int returnCode) {
                if(returnCode == 200){
                    ...
                    ArrayList<Voluntariado> listaVoluntariados = gson.fromJson(resultado,foundType);
                    view.atualizaListaVoluntariados(listaVoluntariados);
                } else {
    ...
    public interface View{
        ...
        void atualizaListaVoluntariados(ArrayList<Voluntariado> listaVoluntariados);
    }
}
